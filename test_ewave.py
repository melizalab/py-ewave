...
class TestEwave(unittest.TestCase):
    ...
    def write_file(self, fname, tgt_type=None):
        ...
        with ewave.open(self.test_file, "w",
    ...
    def test00_invalidtype(self):
        ...
        try:
            ...
            self.assertFalse(os.path.exists(self.test_file), "file was created for invalid type")
            return
    ...
    def test02_modify(self):
        ...
        with ewave.open(self.test_file,"w+",sampling_rate=Fs,dtype='f',nchannels=nchan) as fp:
            fp.write(data)
            d2 = fp.read(memmap='r+')
